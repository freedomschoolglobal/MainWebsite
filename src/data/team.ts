...
export const advisors: LeadershipMember[] = [
  {
    ...
    bio: 'An educator since 2003, with a Master’s in Educational Technology from UBC. Noan has spent his career building nature-based, project-driven schools around the world, from Green School Bali to founding Budapest’s REAL School — and now advises The Freedom School on strategy and program design.',
